...
puts
puts "Run 3: logic:'FCFS', modifiers: {}, floors: 10, elevators: 3, occupants: 40, debug:false"
Simulation.new(logic:'FCFS', modifiers: {}, floors: 10, elevators: 3, occupants: 40, debug:false).run
